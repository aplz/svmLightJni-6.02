...
public class LearnParam {
    ...
    /**
     * If nonzero, it will use the shared slack variable mode. In svm_learn_optimization it requires that the slack-id is set for every
     * training example.
     */
    public long sharedslack;

    /**
     * Do not check KT-Conditions at the end of optimization for examples removed by shrinking. WARNING: This might lead to sub-optimal
     * solutions!
     */
